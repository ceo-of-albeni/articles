...
export default function Reviewer() {
    return (
        <>
            <section className="reviewer_section container">
                <div className="bgi">
                ...
                <div className="reviewer_thema">
                    <p className="upper ">CREATIVITY IS CONTAGIOUS</p> 
                    <p className="lower">, Pass it on</p> 
                </div>
                <div className="reviewer_user">
                    ...
                    <div className="user_data">
                        <p>First name: Azizbek</p>
                        <p>Last name: Karimov</p>
                        <p>Email: krmvzz03@gmail.com</p>
                    </div>
                </div>
                ...
                <div className="table">
                    <table>
                        <tr>
                            ...
                            <td className="tb_th">Updated</td>
                            <td className="tb_th">Status</td>
                            <td className="tb_th">Accept</td>
                            <td className="tb_th">Reject</td>
                            <td className="tb_th">Submit</td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td>
                            <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 0C9.87827 0 7.84344 0.842855 6.34315 2.34315C4.84285 3.84344 4 5.87827 4 8C4 10.1217 4.84285 12.1566 6.34315 13.6569C7.84344 15.1571 9.87827 16 12 16C14.1217 16 16.1566 15.1571 17.6569 13.6569C19.1571 12.1566 20 10.1217 20 8C20 5.87827 19.1571 3.84344 17.6569 2.34315C16.1566 0.842855 14.1217 0 12 0ZM2.93 3.82C2.01572 4.56996 1.27883 5.51305 0.772242 6.58156C0.265651 7.65006 0.00192585 8.81748 0 10C0 12.1217 0.842855 14.1566 2.34315 15.6569C3.84344 17.1571 5.87827 18 8 18C8.64 18 9.27 17.92 9.88 17.77C8.12 17.38 6.5 16.5 5.17 15.29C4.21237 14.7776 3.41174 14.015 2.85347 13.0834C2.2952 12.1517 2.00023 11.0861 2 10C2 9.7 2.03 9.41 2.07 9.11C2.03 8.74 2 8.37 2 8C2 6.56 2.32 5.13 2.93 3.82ZM16.09 4.08L17.5 5.5L11 12L7.21 8.21L8.63 6.79L11 9.17" fill="#C11414"/>
                            </svg>
                            </td>
                            <td><button>submit</button></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 0C9.87827 0 7.84344 0.842855 6.34315 2.34315C4.84285 3.84344 4 5.87827 4 8C4 10.1217 4.84285 12.1566 6.34315 13.6569C7.84344 15.1571 9.87827 16 12 16C14.1217 16 16.1566 15.1571 17.6569 13.6569C19.1571 12.1566 20 10.1217 20 8C20 5.87827 19.1571 3.84344 17.6569 2.34315C16.1566 0.842855 14.1217 0 12 0ZM12 2C15.32 2 18 4.69 18 8C18 11.32 15.32 14 12 14C10.4087 14 8.88258 13.3679 7.75736 12.2426C6.63214 11.1174 6 9.5913 6 8C6 6.4087 6.63214 4.88258 7.75736 3.75736C8.88258 2.63214 10.4087 2 12 2ZM2.93 3.82C2.01572 4.56996 1.27883 5.51305 0.772242 6.58156C0.265651 7.65006 0.00192585 8.81748 0 10C0 12.1217 0.842855 14.1566 2.34315 15.6569C3.84344 17.1571 5.87827 18 8 18C8.64 18 9.27 17.92 9.88 17.77C8.12 17.38 6.5 16.5 5.17 15.29C4.21237 14.7776 3.41174 14.015 2.85347 13.0834C2.2952 12.1517 2.00023 11.0861 2 10C2 9.7 2.03 9.41 2.07 9.11C2.03 8.74 2 8.37 2 8C2 6.56 2.32 5.13 2.93 3.82Z" fill="black"/>
                            </svg></td>
                            <td><button>submit</button></td>
                        </tr>
